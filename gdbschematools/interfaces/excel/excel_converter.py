"""
Conversion of properties between the expected value for excel text outputs and the structure.
...
def value_to_cell(value:any, field_type:str) -> Union[str, int, float]:
...
class _GDBConverter():
    ...
    def __init__(self, xls_to_struct:bool=True) -> None:
        """Convert values from those in Excel and those in the structure and vice-versa.
...
# Excel to Structure
xl2st = _GDBConverter(xls_to_struct=True)


# Structure to Excel
st2xl = _GDBConverter(xls_to_struct=False)